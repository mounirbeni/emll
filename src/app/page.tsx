...
export default function Home() {
  return (
    <>
      {/* Mobile App Layout */}
      <div className="md:hidden min-h-screen bg-accent">
        {/* Fullscreen Hero */}
        <Hero />
            ...
            <Link href="/blog">
              <MobileCard className="text-center py-6 cursor-pointer">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="font-semibold text-charcoal">Read Blog</p>
                </div>
              </MobileCard>
            </Link>
        ...
        <section className="px-4 py-8 mb-6">
          <MobileCard className="bg-primary text-white p-6">
      ...
      <div className="hidden md:block min-h-screen bg-white">
        ...
        {/* FeaturedExperiences is removed */}
