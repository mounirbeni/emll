...
interface BookingsClientProps {
    initialBookings: (Booking & { experience?: { title: string } } & { user?: { name: string | null } | null })[]
}
...
export default function BookingsClient({ initialBookings }: BookingsClientProps) {
    ...
    const handleViewDetails = (booking: Booking & { experience?: { title: string } }) => {
                    ...
                    filteredBookings.map((booking) => (
                        <Card key={booking.id} className="overflow-hidden rounded-xl border-border hover:shadow-md transition-all duration-200">
                            <CardContent className="p-0 flex h-full">
                                ...
                                <div className={`w-20 flex-shrink-0 flex flex-col items-center justify-center p-3 text-white ${booking.status === 'CONFIRMED' ? 'bg-emerald-500' :
                                ...
                                <div className="flex-1 p-3 flex flex-col justify-between min-w-0">
                                    <div className="flex justify-between items-start gap-2">
                                        <div className="min-w-0">
                                            ...
                                            <p className="text-xs text-muted-foreground truncate mt-0.5">{booking.userName}</p>
                                        </div>
                                    ...
                                    <tr key={booking.id} className="hover:bg-muted/30 transition-colors">
                                        ...
                                        <td className="px-5 py-4">
                                            <div className="flex items-center gap-2 text-muted-foreground text-sm">
                                                ...
                                                <span className="truncate max-w-[150px]">{booking.userEmail}</span>
                                            </div>
                                            {booking.userPhone && (
                                        ...
                                        <td className="px-5 py-4">
                                            <div className="font-medium text-foreground max-w-[200px] truncate">{booking.experience?.title}</div>
                                        </td>
                                        <td className="px-5 py-4">
