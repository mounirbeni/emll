  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Choose how to pay for your bookings.</p>
      </div>
      ...
      <Card className="border-primary/20 bg-primary/5 rounded-2xl">
        <CardContent className="p-6">
          ...
          <p className="text-sm text-gray-600 mt-1">Go to a booking and choose &quot;Pay now&quot; to select your payment method.</p>
