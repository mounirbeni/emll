...
const StatusIcon = ({ status }: { status: BookingStatus }) => {
    switch (status) {
        ...
        case BookingStatus.COMPLETED: return <CheckCircle className="w-5 h-5 text-blue-600" />;
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                                ...
                                <div>
                                    ...
                                    <p className="font-medium text-gray-900 text-sm break-all">{booking.email}</p>
                                </div>
                            </div>
                            {booking.phone && (
                                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
