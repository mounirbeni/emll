        ...
        >
            ...
            >
                ...
                <input
                    ...
                    className={`w-full text-black placeholder:text-gray-400 font-medium focus:outline-none bg-white ${isHero ? "text-base" : "text-sm"
                        }`}
                />
            </div>
            ...
            <div className="p-2 w-full md:w-auto flex justify-center md:block">
                <Button
                    type="submit"
                    className={`bg-primary hover:bg-accent text-white rounded-full p-0 flex items-center justify-center shadow-md transition-transform hover:scale-105 ${isHero ? "w-12 h-12" : "w-10 h-10"}
                        }`}
                >
