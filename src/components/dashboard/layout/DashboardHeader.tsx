        ...
        <header className="sticky top-0 z-40 flex h-24 w-full items-center gap-4 bg-white border-b border-gray-100 px-8 transition-all duration-300 shadow-sm">
            ...
            <Sheet>
                <SheetTrigger asChild>
                    <Button variant="ghost" size="icon" className="lg:hidden text-gray-500 hover:text-primary hover:bg-orange-50 rounded-xl">
            ...
            <div className="flex-1 hidden md:block">
                <nav className="flex text-sm text-gray-500 font-medium items-center">
                    ...
                    <span className="text-primary bg-orange-50 px-3 py-1 rounded-full">Dashboard</span>
                </nav>
            </div>
            ...
            <div className="flex-1 md:flex-initial max-w-md w-full relative group">
                ...
                <Input
                    ...
                    className="pl-12 bg-white border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary h-12 transition-all rounded-full font-normal"
                />
            </div>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-64 p-2 rounded-3xl shadow-xl border-gray-100 bg-white">
                        ...
                        <DropdownMenuItem asChild>
                            <Link href="/client/profile" className="flex items-center gap-3 p-3 rounded-2xl cursor-pointer hover:bg-orange-50 text-gray-600 hover:text-primary transition-colors font-medium">
                                <User className="h-4 w-4" />
                                <span>My Profile</span>
                            </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                            <Link href="/client/bookings" className="flex items-center gap-3 p-3 rounded-2xl cursor-pointer hover:bg-orange-50 text-gray-600 hover:text-primary transition-colors font-medium">
                                <ShoppingBag className="h-4 w-4" />
                                <span>Bookings</span>
                            </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                            <Link href="/client/wishlist" className="flex items-center gap-3 p-3 rounded-2xl cursor-pointer hover:bg-orange-50 text-gray-600 hover:text-primary transition-colors font-medium">
                                <Heart className="h-4 w-4" />
                                <span>Wishlist</span>
                            </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                            <Link href="/client/settings" className="flex items-center gap-3 p-3 rounded-2xl cursor-pointer hover:bg-orange-50 text-gray-600 hover:text-[#FF5F00] transition-colors font-medium">
